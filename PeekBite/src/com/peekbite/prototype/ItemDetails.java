...
//			logout from fb session
			...
			public void onClick(View v) {
				...
				finish();// 关掉自己
				Toast.makeText(ItemDetails.this, "You logged out!",
		...
		/*
		 * byte[] b = extras.getByteArray("dishimage"); Bitmap bmp =
	...
	public void onClick(View v) {
		...
		case R.id.type3layout:
			Intent intent3 = new Intent(ItemDetails.this,
		...
		case R.id.type5layout:
			Intent intent5 = new Intent(ItemDetails.this,
